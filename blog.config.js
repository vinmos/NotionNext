...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个PPT召唤师, Hi，我是一个打工人,Hi，我是一个顺应天性的人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Verzerrt', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '吾心即宇宙🤖Welcome to the crib ~', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://verzerrt.dpdns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,verzerrt', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'vinmos2099@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/5319126541', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/vinmos', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/s/VZllOZbv_d7W8CbMkWeL_Q', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '本站所有资源收集整理于网络,本站不参与制作,用于互联网爱好者学习和研究,如不慎侵犯了您的权利,请及时联系站长处理删除。敬请谅解！ 侵权删帖/违法举报/投稿等请联系邮箱', // 备案号 闽ICP备XXXXXXX
